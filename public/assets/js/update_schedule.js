...
const check = () => {
    ...
    if (openedHour.value == '' || closedHour.value == '' || happy_start.value == '' || happy_end.value == '') {
        ...
        if (openedHour.value < 24 && closedHour.value < 24) {
            ...
            closedHour.classList.add('is-invalid');
            errorOpen.classList.remove('d-none');
            errorOpen.innerHTML = 'Les horaires ne peuvent pas être supérieurs à 23';
        }
        if (happy_start.value < 24 && happy_end.value < 24) {
            ...
            happy_end.classList.add('is-invalid');
            errorHappy.classList.remove('d-none');
            errorHappy.innerHTML = 'Les horaires ne peuvent pas être supérieurs à 23';   
        }
    }
