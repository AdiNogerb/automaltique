            ...
            <fieldset class="d-flex flex-column align-items-center">
                <form action="#" method="post" class="noto-sans w-100">
                    <div class="mb-3">
                        ...
                        <input type="text" name="product-name" id="product-name" class="form-control" value="<?=$validName??''?>" title="Uniquement des lettres, chiffres, points, traits d'union et apostrophes" placeholder="exemple: ''La mousse au chocolat du patron''" pattern="<?=$this->adaptRegex(REGEX_PRODUCT_NAME)?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="product-description" id="product-description" class="form-control" value="<?=$validDescription??''?>" title="Uniquement des lettres, chiffres, points, traits d'union, apostrophes et virgules" placeholder="exemple: ''Chocolat, poils, ongles, dents''" pattern="<?=$this->adaptRegex(REGEX_PRODUCT_DESCRIPTION)?>">
                        <p id="error-description" class="d-none text-danger fst-italic">Uniquement des lettres, chiffres, points, traits d'union, apostrophes et virgules</p>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="product-price" id="product-price" class="form-control" value="<?=$validPrice??''?>" title="Uniquement des chiffres, avec point ou virgule en séparateur" placeholder="exemples: ''2''  ou  ''2.5''  ou  ''2,50''" pattern="<?=$this->adaptRegex(REGEX_PRICE)?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="product-pint" id="product-pint" class="form-control" value="<?=$validPint??''?>" title="Uniquement des chiffres, avec point ou virgule en séparateur" placeholder="exemples: ''2''  ou  ''2.5''  ou  ''2,50''" pattern="<?=$this->adaptRegex(REGEX_PRICE)?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="product-happy" id="product-happy" class="form-control" value="<?=$validHappy??''?>" title="Uniquement des chiffres, avec point ou virgule en séparateur" placeholder="exemples: ''2''  ou  ''2.5''  ou  ''2,50''" pattern="<?=$this->adaptRegex(REGEX_PRICE)?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="product-bottle" id="product-bottle" class="form-control" value="<?=$validBottle??''?>" title="Uniquement des chiffres, avec point ou virgule en séparateur" placeholder="exemples: ''2''  ou  ''2.5''  ou  ''2,50''" pattern="<?=$this->adaptRegex(REGEX_PRICE)?>">
