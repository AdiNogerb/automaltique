        ...
        <div class="col-10 col-sm-8">
            ...
            <fieldset class="d-flex flex-column align-items-center">
                <form action="#" method="post" class="noto-sans w-100">
                    ...
                    <div class="mb-3">
                        <label for="product-pint" class="form-label">Prix 50cl :</label>
                    ...
                    <div class="mb-3">
                        <label for="product-happy" class="form-label">Prix Happy :</label>
                    ...
                    <div class="mb-3">
                        <label for="product-bottle" class="form-label">Prix Bouteille :</label>
