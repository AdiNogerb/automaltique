...
<div class="container mb-5">
    <div class="row justify-content-center">
        <div class="col-10 col-sm-8">
            ...
            <p class="<?=(isset($requiredField)) ? '' : 'd-none'?> fst-italic">*Champ obligatoire</p>
            <fieldset class="d-flex flex-column align-items-center">
                <form action="#" method="post" class="noto-sans w-100">
                    <div class="mb-3">
                        ...
                        <p id="error-name" class="d-none text-danger fst-italic">Uniquement des lettres, chiffres, points, traits d'union et apostrophes</p>
