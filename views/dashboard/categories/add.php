        ...
        <div class="col-10 col-sm-6">
            <fieldset class="d-flex flex-column align-items-center">
                ...
                <form action="#" method="post" class="noto-sans w-100">
                    ...
                    <input type="text" name="category" id="category" class="form-control" title="Uniquement des lettres, traits d'union et apostrophe" pattern="<?=$this->adaptRegex(REGEXP_NAME)?>" value="<?=$name??''?>" required>
